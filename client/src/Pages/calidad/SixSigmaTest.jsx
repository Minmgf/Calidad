...
export const SixSigmaTest = () => {
    ...
    useEffect(() => {
        ...
        axios.get('https://calidad-mu.vercel.app/questions/ModeloSix Sigma')
            .then(response => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post('https://calidad-mu.vercel.app/evaluations', evaluationData);
            ...
            <div className="flex flex-col items-center justify-center h-full max-w-4xl mx-auto my-12 text-center">
                <div className="w-full p-8 bg-gray-300 rounded-md bg-opacity-10">
                    <h1 className="text-4xl font-bold text-white ">
                        Evaluación bajo el modelo Six Sigma
                    </h1>
