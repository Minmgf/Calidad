...
const RiskManager = () => {
    ...
    const loadCrud = (category) => {
        ...
        axios.get(`https://calidad-5vft.vercel.app/risks/${formattedCategory}`)
            .then(response => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://calidad-5vft.vercel.app/risks', riskToAdd)
            .then(response => {
    ...
    const handleDelete = async (id) => {
        if (window.confirm('¿Está seguro de que desea eliminar este riesgo?')) {
            try {
                await axios.delete(`https://calidad-5vft.vercel.app/risks/${id}`)
    ...
    const handleUpdate = async (updatedRisk) => {
        try {
            await axios.put(`https://calidad-5vft.vercel.app/risks/${updatedRisk._id}`, updatedRisk);
